...
| Deploy so the flow runs on its own | Deployment chain plus the inbox trigger going live (Appendices A1 and A2) | ⚠️ written and syntax-verified, not yet executed end to end |
